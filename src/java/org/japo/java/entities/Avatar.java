...
public final class Avatar implements Serializable {
    ...
    public final boolean validarImagen() {
        return UtilesBase64.validarImagenBase64(imagen);
    }
    ...
    public static final boolean validarImagen(String imagen) {
        return UtilesBase64.validarImagenBase64(imagen);
    }
}
