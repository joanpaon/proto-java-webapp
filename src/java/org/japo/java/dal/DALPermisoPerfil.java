...
public final class DALPermisoPerfil {
    ...
    public List<PermisoPerfil> obtenerPermisos() {
        // SQL
        String sql = ""
                + "SELECT "
                + "* "
    ...
    public PermisoPerfil obtenerPermiso(int id) {
        // SQL
        String sql = ""
                + "SELECT "
                + "* "
    ...
    public List<PermisoPerfil> obtenerPermisos(int perfil) {
        // SQL
        String sql = ""
                + "SELECT "
                + "* "
    ...
    public boolean insertarPermiso(PermisoPerfil permiso) {
        // SQL
        final String SQL = ""
                + "INSERT INTO "
                + "permisos_perfil "
    ...
    public boolean borrarPermiso(PermisoPerfil permiso) {
        // SQL
        final String SQL
                = "DELETE FROM "
                + "permisos_perfil "
    ...
    public boolean modificarPermiso(PermisoPerfil permiso) {
        // SQL
        final String SQL = ""
                + "UPDATE "
                + "permisos_perfil "
    ...
    public List<PermisoPerfil> obtenerPaginaPermisos(long indice, int longitud) {
        // SQL
        String sql = ""
                + "SELECT "
                + "* "
